...
async function main() {
    try {
        ...
        const CreditRecord = await ethers.getContractFactory("CreditRecord");
        ...
        const address = await creditRecord.getAddress();
        console.log("CreditRecord deployed to:", address);
